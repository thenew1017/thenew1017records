...
(async () => {
  ...
  console.log("Navigating to https://thenew1017records.in ...");
  ...
  await page.goto('https://thenew1017records.in', { waitUntil: 'networkidle0' });
  console.log("Home page loaded. Waiting 2 seconds...");
  await new Promise(r => setTimeout(r, 2000));
  
  console.log("Navigating to /artists ...");
  await page.goto('https://thenew1017records.in/artists', { waitUntil: 'networkidle0' });
  console.log("Artists page loaded. Waiting 2 seconds...");
  await new Promise(r => setTimeout(r, 2000));
  
  console.log("Navigating to /applications ...");
  await page.goto('https://thenew1017records.in/applications', { waitUntil: 'networkidle0' });
